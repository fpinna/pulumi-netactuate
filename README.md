...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `netactuate` with the `NAME` of your provider.
...
before:
  ...
  - make tfgen
builds:
- binary: pulumi-resource-netactuate
  dir: provider
  goarch:
  - amd64
  - arm64
  ...
  ignore: []
  ldflags:
  - -X github.com/pulumi/pulumi-netactuate/provider/pkg/version.Version={{.Tag}}
  main: ./cmd/pulumi-resource-netactuate/
  sort: asc
  use: git
release:
  disable: false
...
├── config.yaml
├── metadata.json
├── pulumi-netactuate_darwin_amd64_v1
│   └── pulumi-resource-netactuate
├── pulumi-netactuate_darwin_arm64
│   └── pulumi-resource-netactuate
├── pulumi-netactuate_linux_amd64_v1
│   └── pulumi-resource-netactuate
├── pulumi-netactuate_linux_arm64
│   └── pulumi-resource-netactuate
├── pulumi-netactuate_windows_amd64_v1
│   └── pulumi-resource-netactuate.exe
└── pulumi-netactuate_windows_arm64
    └── pulumi-resource-netactuate.exe
```
